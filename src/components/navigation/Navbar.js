// Aquí si usaremos "variables de estado" para practicar
...
import oodots from 'assets/img/loading-dots.gif'
import ooboomslag from 'assets/img/boomslag.png'
      ...
      <div className="px-4 sm:px-6">
        <div className="-ml-4 -mt-2 hidden lg:flex flex-wrap items-center justify-between sm:flex-nowrap md:px-4 px-2">
          ...
          <div className="ml-4 mt-2 flex-shrink-0">
            ...
            <NavLink to='/contacto' className="text-lg inline-flex font-semibold leading-6 text-gray-900 border-b-2 border-white hover:border-orange-500 transition duration-300 ease-in-out mx-4">Contacto</NavLink>
